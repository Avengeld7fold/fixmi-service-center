...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "fixmi service center digital",
    "tempat service hp terdekat bali",
    "apple repair bali",
    "iphone repair bali kuta",
    "android repair denpasar",
  ],
  authors: [{ name: "FIXMI Service Center", url: SITE_URL }],
  creator: "FIXMI Service Center",
  publisher: "FIXMI Service Center",
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "FIXMI Service Center — Precision Repair Lab",
      },
    ],
  },
  twitter: {
  ...
  "@graph": [
    {
      ...
      alternateName: "FIXMI Service Center",
      url: SITE_URL,
