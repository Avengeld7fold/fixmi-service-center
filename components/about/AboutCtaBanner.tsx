...
export default function AboutCtaBanner() {
  ...
  const waMessage =
    dict.locale === "en"
      ? "Hello FIXMI Service Center, I am reading the FIXMI profile on your website and would like a free repair consultation:\n\n• Device Model: \n• Issue / Symptoms: "
