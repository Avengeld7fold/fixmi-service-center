        ...
        <table className="w-full border-separate border-spacing-0 text-left">
          <thead className="bg-panel">
            <tr>
              ...
              <th className="sticky left-0 top-0 z-30 min-w-[8.5rem] lg:min-w-[11rem] border-b border-r border-panel-border bg-panel px-3 lg:px-4 pb-3 pt-2 text-center align-middle [background-clip:padding-box]">
              ...
              {variants.map((v) => (
                <th
                  key={v.Key}
                  className="sticky top-0 z-20 min-w-[7.5rem] lg:min-w-[8.5rem] border-b border-panel-border bg-panel px-3 lg:px-4 pb-3 pt-2 text-center align-middle [background-clip:padding-box]"
                >
                  <span className="block font-mono text-[0.6875rem] uppercase tracking-[0.14em] text-foreground text-center">
