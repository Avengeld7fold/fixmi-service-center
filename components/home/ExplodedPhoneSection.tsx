...
const ALL_13_LAYERS: LayerDefinition[] = [
  ...
  { step: 6,  fileNumber: 8,  file: "/images/services/Taptic-Engine.webp", name: "Taptic Engine Haptic Vibration", subName: "Motor Getar Presisi", calloutId: "speaker-housing" },
...
const SERVICE_CALLOUTS: ServiceCallout[] = [
  ...
  },
  {
    ...
    revealStart: 0.18,
    revealEnd: 0.32,
    circleImage: "/images/services/Front-Camera.webp",
    icon: ScanFace,
    hotspot: { x: 50, y: 8 },
