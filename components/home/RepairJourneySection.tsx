  ...
  const repairSteps: JourneyStep[] = useMemo(() => [
    {
      ...
      imageUrl: "/images/iphone-broken.png",
      targetRotate: -4.5,
      targetY: -12,
      zIndex: 10,
    },
            ...
            {repairSteps.map((step, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {/* ── BOTTOM SECTION: 42% HEIGHT (PHOTO / IMAGE CONTAINER) ── */}
                  <div className="h-[42%] w-full relative bg-[#101013] overflow-hidden rounded-b-lg xl:rounded-b-xl flex items-center justify-center p-2">
                    {step.imageUrl ? (
                      <div className="relative w-full h-full p-2 flex items-center justify-center">
                        <Image
                          ...
                          alt={step.title}
                          fill
                          className="object-contain p-2 group-hover:scale-105 transition-transform duration-300 ease-[cubic-bezier(0.23,1,0.32,1)]"
          ...
          {repairSteps.map((step, idx) => {
            ...
            return (
              ...
              >
                ...
                {/* ── BOTTOM SECTION: 42% HEIGHT (PHOTO / IMAGE CONTAINER) ── */}
                <div className="h-[42%] w-full relative bg-[#101013] overflow-hidden rounded-b-xl flex items-center justify-center p-2">
                  {step.imageUrl ? (
                    <div className="relative w-full h-full p-2 flex items-center justify-center">
                      <Image
                        src={step.imageUrl}
